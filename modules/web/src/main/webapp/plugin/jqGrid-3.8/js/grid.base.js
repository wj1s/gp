...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		$("<div id='lui_"+this.id+"'></div>").append(ii).insertBefore(gv);
		...
		if( ts.p.toolbar[0] ) {
			...
			if(ts.p.toolbar[1]=="both") {
				...
				$(grid.uDiv).insertBefore(grid.hDiv).addClass("ui-userdata-top ui-state-default").attr("id","t_"+this.id);
				$(grid.ubDiv).insertAfter(grid.hDiv).addClass("ui-userdata-bottom ui-state-default").attr("id","tb_"+this.id);
