<html>
	...
	<body>
	<form id='techReptForm' name="techReptForm"  action="${request.contextPath}/report/tech-reporting!reSubmitTechReport.action"  method='post'>		
		<input type='hidden' name='formMap.id' value='${formMap.tech.id}'/>
		<input type='hidden' name='formMap.workflowId' value='${formMap.workflowId}'/>
	</form>		
		<div id="body_div"> 
