<html>
	<head>
		...
		<script type="text/javascript"
			src="${request.contextPath}/plugin/jsTreeV1.0rc2/jquery.jstree.js"></script>
		<script type="text/javascript"
			src="${request.contextPath}/plugin/jsTreeV1.0rc2/jquery.cookie.js"></script>
		<script type="text/javascript"
			src="${request.contextPath}/plugin/jsTreeV1.0rc2/jquery.hotkeys.js"></script>
		<script type="text/javascript">
			$(document).ready(function(){
				var url = '${request.contextPath}/system/system!getUserTree.action?timestamp='+new Date().getTime();
				...
				$("#theTree").delegate("li","click", function (e) {
					if ($(this).attr('empId') != undefined){
						var empId = $(this).attr('empId');
						var url = '${request.contextPath}/system/system!getUserPopedom.ajax?id=' + empId;
						$('#content').load(url);
					}
				});
